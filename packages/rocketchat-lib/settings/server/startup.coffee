Meteor.startup ->
	...
	RocketChat.settings.add 'Layout_Home_Body', 'Welcome to Chat Locker <br> Go to APP SETTINGS -> Layout to customize this intro.', { type: 'string', multiline: true, group: 'Layout', public: true }
	...
	RocketChat.settings.add 'Layout_Sidenav_Footer', '<a href="https://github.com/sscpac/chat-locker" class="logo" target="_blank"> <span style="font-weight:bold;font-size:20px;color:white;">Chat Locker</span> <small><i class="icon-github-circled"></i> Fork it on github</small> </a>', { type: 'string', group: 'Layout', public: true, i18nDescription: 'Layout_Sidenav_Footer_description' }
